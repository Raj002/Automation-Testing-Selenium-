 ...
 * 
 * 
 *  FluentWait -- http://seleniumsimplified.com/2012/08/22/fluentwait-with-webelement/
 *
 * Copyright [2014] [Perwez]
 * 
...
public class Tool {
	...
	/**
	 ...
	 /*Wait and element to appear after going back to the previous page.
	  * This method will be used when you click on some button or links and wants to go back to the previous page
	  * and checking whether you are in the correct page .
	  * @param WebDriver	The driver object to use to perform this element search
	  * @param locator	selector to find the element
	  * @param int	The time in seconds to wait until returning a failure
	  * 
...
return null; 
	 ...
	 * 
	 */
	public static  boolean waitForPageTOLoadCompletely(WebDriver driver, int waitTime) {
...
public static void waitForSeconds(int seconds) {
	try {
		...
		//log("Timeout after waiting " + seconds + " Seconds.");
		}
}
}
